...
namespace Swag.Controllers
{
    public class LeaveRequestsController : Controller
    {
        ...
        public LeaveRequestsController(SwagContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,StartDate,EndDate,Reason")] LeaveRequest leaveRequest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StartDate,EndDate,Reason")] LeaveRequest leaveRequest)
        {
